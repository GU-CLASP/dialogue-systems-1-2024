...
from dialog.test.dialogtest import run_dialog_test_sem


test_contents = yaml.load(open('dialog/music_personality/test/dialog_coverage_sem.yml').read(), yaml.Loader)
